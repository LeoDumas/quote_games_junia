...
function Game() {
  ...
  // Stable refs so callbacks can read the latest values without extra deps
  ...
  // Countdown timer — resets on each new round load
  useEffect(() => {
  ...
  // Keyboard shortcuts: 1–4 to pick answer, Enter/Space to advance
  useEffect(() => {
    const onKey = (e) => {
